...
public class Repository {
  ...
  public static String[][] data = {
    ...
    {"4", "Sight", "Gastown", "4",
      ...
      "neighboring Downtown Eastside area, while the up-and-coming Railtown district is home to edgy fashion \n\n" +
      "studios."
    },
    {"5", "Sight", "Granville Island", "4",
      "Granville Island is a peninsula and shopping district in Vancouver, British Columbia, Canada. It is \n\n" +
      "located across False Creek from Downtown Vancouver under the south end of the Granville Street Bridge."
    },
    {"6", "Restaurant", "The Teahouse in Stanley Park", "1",
      "Cheerful spot in the park offering refined seafood & New Canadian cuisine, with brunch & cocktails."
    },
    {"7", "Restaurant", "Cliff House Restaurant", "1",
      "Overlooking the Capilano Canyon, suspension bridge and West Coast rainforest, the Cliff House Restaurant \n\n" +
      "offers a casual West Coast inspired menu during Capilano Suspension Bridge Park's regular operating hours."
    },
    {"8", "Restaurant", "Red Door Bistro Restaurant", "1",
      "High-end French & fusion fare served in a cozy, refined space with an open kitchen behind the bar."
    },
    {"9", "Restaurant", "The Old Spaghetti Factory (Gastown)", "1",
      "Family-friendly chain eatery featuring traditional Italian entrees amid turn-of-the-century decor. \n\n" +
      "oldspaghettifactory.ca"
    },
    {"10", "Restaurant", "Dockside Restaurant", "1",
      "Eatery with a brewery & a waterfront patio offering Pacific NW fare in a dining room with a view."
    }
  };
